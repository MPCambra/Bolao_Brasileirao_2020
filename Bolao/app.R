...
# Confrontos --------------------------------------------------------------
rodadas_confronto <- c(1:max(confrontos$rodada_bolao))

names(rodadas_confronto) <- paste('Rodada',1:max(confrontos$rodada_bolao))
